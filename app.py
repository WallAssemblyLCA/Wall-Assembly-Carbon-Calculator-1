...
if page == "Build Assemblies":
    ...
    # New, duplicated, and deleted walls update active_assembly_id directly.
    # Synchronize the keyed dropdown before it is rendered.
    if st.session_state.get(BUILD_ASSEMBLY_PICKER_KEY) != active["id"]:
        st.session_state[BUILD_ASSEMBLY_PICKER_KEY] = active["id"]
