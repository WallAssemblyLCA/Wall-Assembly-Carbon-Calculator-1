...
- Added drag-and-drop wall-option reordering on the Build Assemblies page. The chosen order is used by the wall selector, comparison charts, Excel export, and PDF report.
